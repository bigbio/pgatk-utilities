package io.github.bigbio.pgatk.utilities.mod;
...
import io.github.bigbio.pgatk.utilities.mod.model.MSModification;
import io.github.bigbio.pgatk.utilities.mod.model.PRIDEModPTM;
import io.github.bigbio.pgatk.utilities.mod.model.PSIModPTM;
...
import io.github.bigbio.pgatk.utilities.mod.utils.Constants;
...
public class ModReader {
    ...
    private static InputStream unimodUrl    = ModReader.class.getClassLoader()
			.getResourceAsStream("unimod.xml");
    private static InputStream psiModUrl    = ModReader.class.getClassLoader()
			.getResourceAsStream("PSI-MOD.obo");
    private static InputStream prideModdUrl = ModReader.class.getClassLoader()
			.getResourceAsStream("pride_mods.xml");
    ...
    public List<PTM> getUnimodPTMs(){
        return new ArrayList<>(unimodController.ptmMap.values());
    }
}
